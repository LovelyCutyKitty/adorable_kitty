(async()=>{
  ...
  const version='cm-20260830-13';
  for(const src of ['data/questions_09.js','data/questions_10.js','data/questions_11.js','code_01.js','code_02.js','code_03.js','code_04.js','code_05.js','code_06.js']) await load(`${src}?v=${version}`);
