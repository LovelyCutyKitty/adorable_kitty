...
(() => {
  ...
  function setupUi() {
    ...
    style.textContent = `.notification-bell{position:relative;border:0;background:transparent;color:#235342;font-size:1.45rem;line-height:1;padding:7px;margin-right:2px}.notification-bell.has-unread:after{content:'';position:absolute;right:5px;top:5px;width:7px;height:7px;border:2px solid #f5f8f6;border-radius:50%;background:#d8483e}.notification-dialog{max-width:520px}.notification-dialog form{min-width:min(92vw,440px)}.notification-list{max-height:min(65vh,540px);overflow:auto}.notice-item{display:block;width:100%;padding:13px 11px;border:0;border-bottom:1px solid #e4ece7;background:#fff;text-align:left;font:inherit;color:#173128}.notice-item.unread{background:#f0f7f3}.notice-item strong,.notice-item small{display:block}.notice-item strong{font-size:.9rem;line-height:1.4;margin:4px 0}.notice-item small{font-size:.78rem;color:#60766d}.notice-type{display:inline-block;font-size:.75rem;color:#235342;font-weight:800}.notice-actions{display:flex;gap:8px;margin-top:10px}.notice-actions button{margin:0}`;
    document.head.append(style);
    document.querySelector('#menuButton')?.insertAdjacentHTML('beforebegin', '<button id="notificationBell" class="notification-bell" type="button" aria-label="변경 알림">🔔</button>');
